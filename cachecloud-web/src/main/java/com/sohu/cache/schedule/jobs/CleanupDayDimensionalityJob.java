...
public class CleanupDayDimensionalityJob extends CacheBaseJob {
     ...
     * 清除实例基础统计
     */
    private static final String CLEAN_INSTANCE_MINUTE_STATS = "delete from instance_minute_stats where collect_time < ?";
    ...
    public void action(JobExecutionContext context) {
        ...
        try {
            ...
            cleanCount = jdbcTemplate.update(CLEAN_INSTANCE_MINUTE_STATS, timeFormat);
