...
<script type="text/javascript" src="/resources/js/appDetail.js?<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript" src="/resources/js/appInit.js?<%=System.currentTimeMillis()%>"></script>
<script type="text/javascript" src="/resources/js/appStat.js?<%=System.currentTimeMillis()%>"></script>
