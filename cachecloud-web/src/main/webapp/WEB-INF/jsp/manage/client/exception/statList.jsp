						...
						<table class="table table-striped table-bordered table-hover" id="tableDataList">
							...
							<tbody>
								<c:forEach items="${clientInstanceExceptionList}" var="clientInstanceException">
									<tr class="odd gradeX">
										<td>
											<a target="_blank" href="/admin/app/index?appId=${clientInstanceException.appId}">${clientInstanceException.appId}</a>
										</td>
										<td>
											<a href="/admin/instance/index?instanceId=${clientInstanceException.instanceId}" target="_blank">${clientInstanceException.instanceId}</a>
										</td>
