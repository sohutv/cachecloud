    ...
    var TableManaged = function () {
        return {
            ...
            init: function () {
                ...
                jQuery('#slot_tableDataList_wrapper>div:first-child').css("display", "none");
            }
        };
    }();
        ...
        $.post(
            ...
            function (data) {
                ...
                if (status == 'success') {
                    ...
                    location.href = "/manage/app/tool/index?tabTag=slotAnalysis";
                } else {
    ...
    <div id="hotkey-div" class="col-md-12">
        <form class="form-inline" role="form" name="ec">
            <div class="form-group col-md-2">
                <label for="slot-select">应用&nbsp;&nbsp;</label>
                <select id="slot-select" name="appId" class="selectpicker show-tick form-control"
            ...
            <div class="form-group col-md-2 col-md-offset-1">
                <label for="slot_instance-select">实例&nbsp;&nbsp;</label>
            ...
            <div class="form-group col-md-1" style="float:right; width: max-content;">
                <button type="button" class="form-control btn green" onclick="submitDiagnostic(5)">slot分析</button>
            </div>
        </form>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div style="float:left">
            <form class="form-inline" role="form" method="post" action="/manage/app/tool/index?tabTag=slotAnalysis"
                  id="appList" name="ec">
...
<div class="row">
    <div class="col-md-12">
        <div class="portlet box light-grey" id="clientIndex">
            ...
            <table class="table table-striped table-bordered table-hover" id="slot_tableDataList">
                <thead>
                <tr>
                    <td>序号</td>
                    <th>appId</th>
                        ...
                        <td>
                            <c:if test="${record.status==1&&record.type!=4}">
                                <button type="button" class="btn btn-sm btn-info"
                                        data-target="#modal-slotAnalysisResult" data-toggle="modal"
