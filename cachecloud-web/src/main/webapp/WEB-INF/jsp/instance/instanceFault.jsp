    ...
    <div style="margin-top: 20px">
        <table class="table table-bordered table-striped table-hover">
            ...
            <c:forEach var="instance" items="${list}" varStatus="status">
                <tr>
                    <td>
                        <a href="/admin/app/index?appId=${instance.appId}" target="_blank">${instance.appId}</a>
                    </td>
                    <td>
                        <a href="/admin/instance/index?instanceId=${instance.instId}" target="_blank">${instance.ip}:${instance.port}</a>
                    </td>
