...
<div class="container">
	<br/>
	<form method="post" action="/admin/app/index?appId=${appDetail.appDesc.appId}&tabTag=app_command_analysis" id="formSingCommand">
		<div class="row">
		...
		if(betweenOneDay == 1){
			...
			$(document).ready(
				function() {
					...
					var commandsUrl = "/admin/app/getCommandStats?appId=" + appId + "&commandName=" + firstCommand + chartParams;
					$.ajax({
						type : "get",
						url : commandsUrl,
						async : true,
