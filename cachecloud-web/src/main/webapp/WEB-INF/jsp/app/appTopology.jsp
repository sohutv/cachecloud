...
<div class="row">
    <div class="page-header">
        <h4>应用拓扑结构-<a href="/admin/app/index?appId=${appDesc.appId}">${appDesc.name}</a></h4>
    </div>
    <div style="margin-top: 20px">
        <table class="table table-bordered table-striped table-hover">
            ...
            <c:forEach var="instance" items="${instanceList}" varStatus="status">
                ...
                <tr>
                    <c:if test="${instance.status==1 || instance.status==0}">
                    <td>
                    ...
                    <td><a href="/server/index?ip=${instance.ip}" target="_blank">${instance.ip}</a>:${instance.port}</td>
                  ...
                  <c:choose>
                     <c:when test="${instance.masterInstanceId >0}">
                         <td>
                             <a href="/admin/instance/index?instanceId=${instance.masterInstanceId}" target="_blank">${instance.masterInstanceId}</a>
                         </td>
                     </c:when>
                     <c:otherwise>
                         <td></td>
