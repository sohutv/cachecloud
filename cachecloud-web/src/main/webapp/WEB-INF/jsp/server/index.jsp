	...
	<div class="container">
	    ...
	    <div class="tabbable-custom">
	        <ul class="nav nav-tabs" id="app_tabs">
	            <li class="active"><a href="#overview" data-url="/server/overview?ip=${ip}&date=${date}" data-toggle="tab">概览</a></li>
	            <li><a href="#cpu" data-url="/server/cpu?ip=${ip}&date=${date}" data-toggle="tab">cpu</a></li>
	            <li><a href="#net" data-url="/server/net?ip=${ip}&date=${date}" data-toggle="tab">net</a></li>
	        	<li><a href="#disk" data-url="/server/disk?ip=${ip}&date=${date}" data-toggle="tab">disk</a></li>
	        </ul>
