...
insert into system_config(config_key,config_value,info,status,order_id) values('redis.shake.home','/opt/cachecloud/redis-shake-tool/','redis-shake安装路径',1,32);
insert into system_config(config_key,config_value,info,status,order_id) values('redis.full-check.home','/opt/cachecloud/redis-full-check/','redis-full-check安装路径',1,33);
insert into system_config(config_key,config_value,info,status,order_id) values('cachecloud.leader.email','xx@sohu.com,yy@qq.com',';领导邮件(逗号隔开)',1,34);
