...
public abstract class MultiKeyPipelineBase extends PipelineBase implements
  ...
  @Override
  public Response<Long> clusterCountKeysInSlot(final int slot) {
  ...
  @Override
  public Response<List<LatencyItem>> latencyLatest(){
    client.latencyLatest();
    return getResponse(BuilderFactory.LATENCY_ITEM_LIST);
  }
  @Override
  public Response<List<LatencyHistoryItem>> latencyHistory(String event){
    client.latencyHistory(event);
    return getResponse(BuilderFactory.LATENCY_HISTORY_ITEM_LIST);
  }
  @Override
  public Response<Long> latencyReset(String... events){
  ...
  @Override
  public Response<String> debug(DebugParams params){
    client.debug(params);
    return getResponse(BuilderFactory.STRING);
  }
