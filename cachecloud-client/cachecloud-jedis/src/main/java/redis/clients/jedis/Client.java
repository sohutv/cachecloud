...
public class Client extends BinaryClient implements Commands {
  ...
  public Client(final String host, final int port, final StatsCollector statsCollector) {
  ...
  @Override
  public void latencyReset(String... events) {
    latencyReset(SafeEncoder.encodeMany(events));
  }

  @Override
  public void latencyHistory(String event) {
    latencyHistory(SafeEncoder.encode(event));
  }
