...
public final class BuilderFactory {
  ...
  public static final Builder<List<LatencyItem>> LATENCY_ITEM_LIST = new Builder<List<LatencyItem>>() {
    @Override
    public List<LatencyItem> build(Object data) {
      if (null == data) {
        return null;
      }
      if (data instanceof List){
        List<Object> nestedResps = (List<Object>) data;
        List<LatencyItem> latencyItems = LatencyItem.from(nestedResps);
        return latencyItems;
      }
      return null;
    }
    ...
    @Override
    public String toString() {
      return "List<LatencyItem>";
    }
  };

  public static final Builder<List<LatencyHistoryItem>> LATENCY_HISTORY_ITEM_LIST = new Builder<List<LatencyHistoryItem>>() {
    @Override
    public List<LatencyHistoryItem> build(Object data) {
      if (null == data) {
        return null;
      }
      if (data instanceof List){
        List<Object> nestedResps = (List<Object>) data;
        List<LatencyHistoryItem> latencyHistoryItems = LatencyHistoryItem.from(nestedResps);
        return latencyHistoryItems;
      }
      return null;
    }
    ...
    @Override
    public String toString() {
      return "List<LatencyHistoryItem>";
    }
  };
