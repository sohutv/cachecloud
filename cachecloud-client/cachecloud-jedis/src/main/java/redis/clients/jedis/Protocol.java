...
public final class Protocol {
  ...
  public static final String CLUSTER_MYID = "myid";

  public static final byte[] BYTES_TRUE = toByteArray(1);
  public static final byte[] BYTES_FALSE = toByteArray(0);
  public static final byte[] BYTES_TILDE = SafeEncoder.encode("~");

  public static final byte[] POSITIVE_INFINITY_BYTES = "+inf".getBytes(Charset.forName("UTF-8"));
  public static final byte[] NEGATIVE_INFINITY_BYTES = "-inf".getBytes(Charset.forName("UTF-8"));
  ...
  private static void processError(final RedisInputStream is) {
    ...
    //权限错误，认为当前连接不可用
    if (message != null && message.contains("NOAUTH Authentication")) {
