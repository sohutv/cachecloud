...
public class JedisSlotBasedConnectionHandler extends JedisClusterConnectionHandler {
  ...
  public JedisSlotBasedConnectionHandler(Set<HostAndPort> nodes,
    ...
    this(nodes, poolConfig, null, connectionTimeout, soTimeout, null);
  }

  public JedisSlotBasedConnectionHandler(Set<HostAndPort> nodes, GenericObjectPoolConfig poolConfig, StatsCollector statsCollector,
      int connectionTimeout, int soTimeout, String password) {
    super(nodes, poolConfig, statsCollector, connectionTimeout, soTimeout, password);
  }
  ...
  public JedisSlotBasedConnectionHandler(Set<HostAndPort> nodes, GenericObjectPoolConfig poolConfig,
    ...
    super(nodes, poolConfig, null, connectionTimeout, soTimeout, user, password, clientName,
