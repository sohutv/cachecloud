...
public class JedisSentinelPool extends JedisPoolAbstract {
  ...
  public JedisSentinelPool(String masterName, Set<String> sentinels,
                           final GenericObjectPoolConfig poolConfig, final StatsCollector statsCollector, final int connectionTimeout, final int soTimeout,
                           final String password, final int database) {
    this(masterName, sentinels, poolConfig, statsCollector,
            connectionTimeout, soTimeout, null, password, database, null,Protocol.DEFAULT_TIMEOUT, Protocol.DEFAULT_TIMEOUT, null, null, null);
  }
  ...
  public JedisSentinelPool(String masterName, Set<String> sentinels,
    ...
    this(masterName, sentinels, poolConfig, null, connectionTimeout, soTimeout, user, password, database, clientName,
  ...
  public JedisSentinelPool(String masterName, Set<String> sentinels,
    ...
    this(masterName, sentinels, poolConfig, null, connectionTimeout, soTimeout, null, password, database, clientName,
      ...
      if (!master.equals(currentHostMaster)) {
        ...
        if (factory == null) {
          factory = new JedisFactory(master.getHost(), master.getPort(), connectionTimeout,
              soTimeout, user, password, database, clientName, statsCollector);
  ...
  private HostAndPort initSentinels(Set<String> sentinels, final String masterName) {
    ...
    for (String sentinel : sentinels) {
      ...
      Jedis jedis = null;
      try {
        jedis = new Jedis(hap.getHost(), hap.getPort(), statsCollector, sentinelConnectionTimeout, sentinelSoTimeout);
  ...
  protected class MasterListener extends Thread {
    ...
    public void run() {
      ...
      while (running.get()) {
        ...
        j = new Jedis(host, port, statsCollector);
