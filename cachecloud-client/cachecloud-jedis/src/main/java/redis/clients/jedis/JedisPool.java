...
public class JedisPool extends JedisPoolAbstract {
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final StatsCollector statsCollector, final String host, int port,
                   int timeout, final String password) {
    this(poolConfig, statsCollector, host, port, timeout, timeout, null, password,
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final StatsCollector statsCollector, final String host, int port,
                   final int connectionTimeout, final int soTimeout, final String user, final String password, final int database,
                   final String clientName, final boolean ssl, final SSLSocketFactory sslSocketFactory,
                   final SSLParameters sslParameters, final HostnameVerifier hostnameVerifier) {
    super(poolConfig, new JedisFactory(host, port, connectionTimeout, soTimeout, user, password,
            database, clientName, ssl, sslSocketFactory, sslParameters, hostnameVerifier, statsCollector));
    this.host = host;
    this.port = port;
