...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
  ...
  protected volatile JedisClusterConnectionHandler connectionHandler;
  ...
  public BinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig, StatsCollector statsCollector) {
    this.connectionHandler = new JedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig, statsCollector,
