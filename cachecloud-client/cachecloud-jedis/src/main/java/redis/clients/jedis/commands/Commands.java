...
public interface Commands {
  ...
  void clientTracking(ClientTrackingParams.Latch latch);

  void clientTracking(ClientTrackingParams.Latch latch, ClientTrackingParams params);
  ...
  void latencyReset(String... events);

  void latencyHistory(String event);
