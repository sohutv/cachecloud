...
CREATE TABLE `instance_config` (
  ...
  `dynamic_param_count` tinyint(4) NOT NULL COMMENT '配置动态参数个数，例如nodes-%d,需要一个动态参数',
...
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-enabled','yes','是否开启集群模式',0,now(),2,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-node-timeout','15000','集群节点超时时间,默认15秒',0,now(),2,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-slave-validity-factor','10','集群从节点,延迟有效性判断因子,默认10秒:(node-timeout * slave-validity-factor) + repl-ping-slave-period',0,now(),2,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-migration-barrier','1','cluster主从迁移至少需要的从节点数,默认1个',0,now(),2,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-config-file','nodes-%d.conf','集群配置文件名称,格式:nodes-{port}.conf',1,now(),2,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('cluster-require-full-coverage','no','节点部分失败期间,其他节点是否继续工作',0,now(),2,1);

insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('port','%d','sentinel实例端口',1,now(),5,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('dir','/tmp','工作目录',0,now(),5,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('sentinel monitor','%s %s %d %d','master名称定义和最少参与监控的sentinel数,格式:masterName ip port num',4,now(),5,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('sentinel down-after-milliseconds','%s 20000','Sentinel判定服务器断线的毫秒数,默认:20秒',1,now(),5,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('sentinel failover-timeout','%s 180000','故障迁移超时时间,默认:3分钟',1,now(),5,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('sentinel parallel-syncs','%s 1','在执行故障转移时,最多有多少个从服务器同时对新的主服务器进行同步,默认:1',1,now(),5,1);

insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('daemonize','no','是否守护进程',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('tcp-backlog','511','TCP连接完成队列',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('timeout','0','客户端闲置多少秒后关闭连接,默认为0,永不关闭',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('tcp-keepalive','0','检测客户端是否健康周期,默认关闭',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('loglevel','notice','日志级别',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('databases','16','可用的数据库数，默认值为16个,默认数据库为0',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('dir','%s','redis工作目录',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('stop-writes-on-bgsave-error','no','bgsave出错了不停写',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-timeout','60','master批量数据传输时间或者ping回复时间间隔,默认:60秒',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-ping-slave-period','10','指定slave定期ping master的周期,默认:10秒',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-disable-tcp-nodelay','no','是否禁用socket的NO_DELAY,默认关闭，影响主从延迟',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-backlog-size','10M','复制缓存区,默认:1mb,配置为:10Mb',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-backlog-ttl','7200','master在没有Slave的情况下释放BACKLOG的时间多久:默认:3600,配置为:7200',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('slave-serve-stale-data','yes','当slave服务器和master服务器失去连接后，或者当数据正在复制传输的时候，如果此参数值设置“yes”，slave服务器可以继续接受客户端的请求',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('slave-read-only','yes','slave服务器节点是否只读,cluster的slave节点默认读写都不可用,需要调用readonly开启可读模式',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('slave-priority','100','slave的优先级,影响sentinel/cluster晋升master操作,0永远不晋升',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('lua-time-limit','5000','Lua脚本最长的执行时间，单位为毫秒',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('slowlog-log-slower-than','10000','慢查询被记录的阀值,默认10毫秒',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('slowlog-max-len','128','最多记录慢查询的条数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('hash-max-ziplist-entries','512','hash数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('hash-max-ziplist-value','64','hash数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('list-max-ziplist-entries','512','list数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('list-max-ziplist-value','64','list数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('set-max-intset-entries','512','set数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('zset-max-ziplist-entries','128','zset数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('zset-max-ziplist-value','64','zset数据结构优化参数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('activerehashing','yes','是否激活重置哈希,默认:yes',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('client-output-buffer-limit normal','0 0 0','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('client-output-buffer-limit slave','512mb 128mb 60','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('client-output-buffer-limit pubsub','32mb 8mb 60','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('hz','10','执行后台task数量,默认:10',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('port','%d','端口',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('maxmemory','%dmb','当前实例最大可用内存',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('maxmemory-policy','volatile-lru','内存不够时,淘汰策略,默认:volatile-lru',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('appendonly','yes','开启append only持久化模式',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('appendfsync','everysec','默认:aof每秒同步一次',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('appendfilename','appendonly-%d.aof','aof文件名称,默认:appendonly-{port}.aof',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('dbfilename','dump-%d.rdb','RDB文件默认名称,默认dump-{port}.rdb',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('aof-rewrite-incremental-fsync','yes','aof rewrite过程中,是否采取增量文件同步策略,默认:yes',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('no-appendfsync-on-rewrite','yes','是否在后台aof文件rewrite期间调用fsync,默认调用,修改为yes,防止可能fsync阻塞,但可能丢失rewrite期间的数据',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('auto-aof-rewrite-min-size','64m','触发rewrite的aof文件最小阀值,默认64m',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('auto-aof-rewrite-percentage','%d','Redis重写aof文件的比例条件,默认从100开始,统一机器下不同实例按4%递减',1,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('rdbcompression','yes','rdb是否压缩',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('rdbchecksum','yes','rdb校验和',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-diskless-sync','no','开启无盘复制',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('repl-diskless-sync-delay','5','无盘复制延时',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('save 900','1','900秒有一次修改做bgsave',0,now(),6,0);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('save 300','10','300秒有10次修改做bgsave',0,now(),6,0);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('save 60','10000','60秒有10000次修改做bgsave',0,now(),6,0);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('maxclients','10000','客户端最大连接数',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('unixsocketperm','0','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('watchdog-period','0','关门狗执行周期，0是不执行',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('requirepass','""','密码',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('masterauth','""','master密码',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('unixsocket','""','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('logfile','""','日志文件名',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('hll-sparse-max-bytes','3000','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('min-slaves-to-write','0','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('min-slaves-max-lag','10','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('aof-load-truncated','yes','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('notify-keyspace-events','""','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('latency-monitor-threshold','0','',0,now(),6,1);
insert into instance_config(config_key,config_value,info,dynamic_param_count,update_time, type, status) values('bind','""','',0,now(),6,1);
